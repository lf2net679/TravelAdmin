...
CREATE TABLE `myapp_article` (
  ...
  PRIMARY KEY (`id`),
  KEY `myapp_article_author_id_e8e173d5_fk_myapp_member_id` (`author_id`),
  CONSTRAINT `myapp_article_author_id_e8e173d5_fk_myapp_member_id` FOREIGN KEY (`author_id`) REFERENCES `myapp_member` (`id`)
